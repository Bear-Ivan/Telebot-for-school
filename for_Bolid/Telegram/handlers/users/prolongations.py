                    ...
                    if diff_time < (reset_podpiska + 1):
                        ...
                        if status_db:
                            if len(res) > 0:
                                ...
                                text_card += "Для выхода в главное меню нажмите /cancel"
...
async def answer_q1(message: types.Message, state: FSMContext):
    ...
    if answer == '/cancel':
        ...
        return await message.reply('Для выхода в главное меню нажмите /cancel')
...
async def answer_q2(message: types.Message, state: FSMContext):
    ...
    try:
        ...
        return await message.reply(
            'Нужно ввести номер и букву класса ребенка(на русском языке).\nДля выхода в главное меню нажмите /cancel')
